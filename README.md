...
3. Maximizes the distance between the closest points and the line.
4. Adjusts weights when a point is misclassified.
5. Uses the final line to predict new data.
